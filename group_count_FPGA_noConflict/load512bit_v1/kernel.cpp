...
// 	} 
			...
			// memcpy(hashVec_globalMem, hashVec.data(), HSIZE * sizeof(Type));
			// memcpy(countVec_globalMem, countVec.data(), HSIZE * sizeof(Type));		--> will be handled as for-loop with #pragma unroll through the compiler -> not working for large HSIZE
