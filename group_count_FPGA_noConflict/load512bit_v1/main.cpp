...
//// Forward declare LinearProbingFPGA_variant1()
    ...
    uint64_t seed = 13;
    size_t (*functionPtr)(uint32_t,size_t);
    functionPtr=&hashx_forNoConflicts;
    generate_data_p0<uint32_t>(arr_h, data_size, distinct_values, functionPtr, 0 , 0 , seed);    
...
//SIMD for FPGA function v1 
    try {
        ...
        LinearProbingFPGA_variant1(q, arr_d, hashVec_d, countVec_d, number_CL*multiplier);
