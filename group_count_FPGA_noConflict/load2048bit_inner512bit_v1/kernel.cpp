	...
	q.submit([&](handler& h) {
		h.single_task<kernelV1>([=]() [[intel::kernel_args_restrict]] {
			...
			*/
			...
			// idea : implement hashVec and countVec with MLAB -- excessive resource consumption
			...
			// idea : implement hashVec and countVec as Registers -- Not working due to excessive resource consumption
			// [[intel::fpga_register]] Type hashVec[HSIZE];
			// [[intel::fpga_register]] Type countVec[HSIZE]; 
