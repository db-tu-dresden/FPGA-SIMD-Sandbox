...
//// Create two buffer on FPGA to realize the hash_map and the count_map structure (= array of type )
    ...
    fpvec<Type, regSize> hash_map_data[m_HSIZE_v];
    fpvec<Type, regSize> count_map_data[m_HSIZE_v];

	// Create 2 buffers, each holding m_HSIZE_v registers of type  integers
    sycl::buffer<fpvec<Type, regSize>> hash_map_Buf(&hash_map_data[0], m_HSIZE_v);
    sycl::buffer<fpvec<Type, regSize>> count_map_Buf(&count_map_data[0], m_HSIZE_v);
////////////////////////////////////////////////////////////////////////////////	
